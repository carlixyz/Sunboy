...
//        this.sprite = game.add.sprite(game.world.centerX, game.world.centerY , 'kid');
        this.sprite = game.add.sprite(435, 250 , 'kid');
        this.sprite.anchor.setTo(0.5, 0.5);
        this.sprite.body.setRectangle(10, 20, 10, 8);
...
//        if (game.input.mousePointer.isDown && this.sprite.body.onFloor()){
        ...
        this.isOnFloor =  this.sprite.body.touching.down || this.sprite.body.onFloor();

        if (game.input.mousePointer.isDown && this.sprite.body.overlap(world.sprite.body)  || this.isOnFloor ){
//        if (game.input.mousePointer.isDown && this.sprite.body.blocked.down){
